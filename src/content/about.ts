export const aboutContent = {
  hero: {
    title: "About",
    titleHighlight: "GreenSpring",
    subtitle: "Transforming businesses through strategic thinking, proven methodologies, and sustainable growth practices."
  },
  
  story: {
    title: "My Journey",
    lead: "My career has been shaped by building, operating, and reimagining businesses from the foundations of retail and marketing to global brands and complex hospitality environments."
  },
  ...
  currentFocus: {
    title: "Current Focus",
    lead: "Most recently, my focus has been on the relaunch and reinvention of a 75-year-old historic beachfront hotel in St. Maarten. This work has included:",
    list: [
      "Reimagining the hotel, bar, restaurant, pool, cabanas, market, and café",
      "Redesigning logos, visual identities, merchandise lines, and brand systems",
      "Introducing new retail, hospitality, and event-driven concepts",
      "Redesigning marketing, operations, and commercial models",
      "Reenergizing a legacy property while honoring its history and role in the community"
    ],
    highlight: "This project represents the culmination of my career—marketing, operations, and commercial concepts reimagined, not in theory, but in practice."
  },
  
  leadership: {
    title: "Leadership Recognition",
    feature: {
      title: "Featured in The Solutions-Oriented Leader (Dr. Rick Goodman)",
      description: "I am featured in The Solutions-Oriented Leader, which highlights my leadership during Hurricane Irma in St. Maarten and the solutions-focused mindset required to protect people, stabilize operations, and move forward under pressure. The excerpt also reflects how I used major event and brand activations—including the Heineken Regatta—to rally teams, support the community, and help drive recovery.",
      quote: "Be Positive, Be Patient, Be Smart, and Family First!",
      closing: "This recognition reflects the same approach I bring to my work today: stay focused on solutions, support people, and deliver results—especially when it matters most."
    }
  },
  
  creative: {
    title: "Creative Work & Authorship",
    lead: "In addition to my professional work, I am also the author of the 3 part book series Living, Laughing & Loving: Poems for an Awesome! Life, a collection focused on perspective, resilience, creativity, and the human experience.",
    body: "Writing and Drawing has been an important creative outlet throughout my career and reflects a belief that strong leadership and effective communication are grounded not only in strategy and execution, but also in empathy, clarity, and self-awareness.",
    highlight: "This creative work complements my professional approach—bringing balance, reflection, and emotional intelligence to complex business and leadership environments."
  },
  
  today: {
    title: "Today",
    lead: "Through GreenSpring Marketing & Management, I work directly with owners, operators, boards, and leadership teams to help them:",
    list: [
      "Launch or relaunch businesses",
      "Reimagine brands, visual identities, and merchandise programs",
      "Improve operations and profitability",
      "Align marketing with execution",
      "Turn ideas into sustainable commercial results"
    ],
    closing: "Whether working with small businesses or global organizations, my approach remains the same: hands-on, practical, and grounded in real operating experience."
  }
}
